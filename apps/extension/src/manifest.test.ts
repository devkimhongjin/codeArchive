...
const BETA_DASHBOARD_MATCH = "https://codearchive-dashboard-beta.netlify.app/*";
const PROGRAMMERS_LESSON_MATCH = "https://school.programmers.co.kr/learn/courses/30/lessons/*";
...
describe("extension manifest", () => {
  ...
  it("injects only the owner-approved Programmers lesson content script scope", () => {
    const programmers = manifest.content_scripts.find((script) => script.js.includes("content/programmers.js"));
    expect(programmers?.matches).toEqual([PROGRAMMERS_LESSON_MATCH]);
