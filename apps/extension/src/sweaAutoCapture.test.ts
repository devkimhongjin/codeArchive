...
const history = `<header><span class="name">Beginner</span></header><form id="contestProbForm"><div class="box-list"><div class="box-list-inner"><div class="problem_smt"><div class="submitter"><dl class="smt_txt"><dt>#Beginner</dt><dd>제출일 : 2026-08-25 10:10</dd></dl></div><div class="info"><ul><li><span>Java</span><span>언어</span></li><li><span>12,345 kb</span><span>메모리</span></li><li><span>67 ms</span><span>시간</span></li><li><span>6 Bytes</span><span>코드길이</span></li><li><span>Pass</span><span>결과</span></li></ul></div></div></div></div></form>`;
...
describe("captureAccepted", () => {
  ...
  it("still saves ACCEPTED source when performance is unavailable", async () => {
    const send = vi.fn<(message: unknown) => Promise<any>>(async () => ({ status: "saved" as const, solutionId: "swea-auto:uuid", savedAt: "2026-08-25T01:11:01.000Z" }));
    await captureAccepted(doc(""), url, accepted, send, () => "uuid", () => ({ status: "synced" }));
