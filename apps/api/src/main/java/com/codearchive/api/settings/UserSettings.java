...
public class UserSettings {
    ...
    @Column(name = "download_filename_template") private String downloadFilenameTemplate = "{platform}-{number}-{title}";
    ...
    public void apply(SettingsRequest r) {
        ...
        downloadFilenameTemplate = r.downloadFilenameTemplate(); gitPathTemplate = r.gitPathTemplate(); lightTheme = r.lightTheme(); darkTheme = r.darkTheme();
