  ...
  return (
    <section className="solutions-layout" aria-label="풀이 아카이브">
      ...
      <div className="content-grid">
        ...
        <SolutionDetail solution={selectedSolution} group={selectedGroup} onSelectSubmission={setSelectedId} mode={mode} onCopy={onCopy} onDownload={onDownload} lightTheme={lightTheme} darkTheme={darkTheme} codeThemeMode={codeThemeMode} onCodeThemeChange={onCodeThemeChange} />
      </div>
    </section>
  )
}
...
function SolutionDetail({ solution, group, onSelectSubmission, mode, onCopy, onDownload, lightTheme, darkTheme, codeThemeMode, onCodeThemeChange }: { solution: Solution | null; group: SolutionGroup | null; onSelectSubmission: (captureId: string) => void; mode: 'local' | 'live'; onCopy: () => void; onDownload: () => void; lightTheme: AccountSettings['lightTheme']; darkTheme: AccountSettings['darkTheme']; codeThemeMode: CodeThemeMode; onCodeThemeChange: (theme: CodeTheme) => void }) {
  return (
